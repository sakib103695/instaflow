...
import imgFrame2147224778 from "@/assets/images/growth/4325472e76c4d5900f149ba036fbb405adf1dee9.png";
import imgFrame2147224779 from "@/assets/images/growth/630e8182ef13d32cd939eef9b57c5bdc733e9dd3.png";
import imgFrame2147224780 from "@/assets/images/growth/8d7301a878915636181f3e0c5abd22deb05d82f7.png";
import imgFrame2147224781 from "@/assets/images/growth/84bd5b09676f0ef13bd88c6c447bd2045d61969c.png";
  ...
  return (
    <div className={`grid rounded-[13px] overflow-hidden ${className ?? ""}`}>
      ...
      <div className="col-start-1 row-start-1 w-full p-4 md:p-5 self-end flex items-center justify-between z-[1]">
        <p className="bg-clip-text bg-gradient-to-b from-white from-[23.469%] to-[#bababa] to-[77.551%] text-transparent font-['Grift:Medium',sans-serif] leading-[normal] not-italic text-base sm:text-lg md:text-[20px] uppercase" style={{ WebkitTextFillColor: "transparent" }}>
          {label}
        </p>
        <ArrowButton />
      </div>
...
export function SmartGrowth() {
  return (
    <>
      <section id="industries" className="w-full px-4 sm:px-6 lg:px-0 max-w-7xl mx-auto pt-16 sm:pt-20 md:pt-28 lg:flex gap-6">
        ...
        <div className="lg:w-[60%] lg:mt-0 mt-8 sm:mt-10 w-full min-w-0">
          <div className="mx-auto w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-[407px_257px] items-end justify-center gap-3 sm:gap-4 md:gap-6">
            <Card image={imgFrame2147224778} label="saloon" className="h-[180px] sm:h-[220px] md:h-[300px] w-full md:w-[407px]" />
            <Card image={imgFrame2147224779} label="spa" className="h-[180px] sm:h-[220px] md:h-[300px] w-full md:w-[257px]" />
          </div>
          <div className="mt-4 sm:mt-6 mx-auto w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-[257px_407px] items-end justify-center gap-3 sm:gap-4 md:gap-6">
            <Card image={imgFrame2147224780} label="Medical spa" className="h-[180px] sm:h-[220px] md:h-[340px] w-full md:w-[257px]" />
            <Card image={imgFrame2147224781} label="Barbershop" className="h-[180px] sm:h-[220px] md:h-[340px] w-full md:w-[407px]" />
          </div>
        </div>
      </section>
      <BrandLogosSlider />
